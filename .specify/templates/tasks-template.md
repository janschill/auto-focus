...
**Tests**: The examples below include test tasks. Tests are REQUIRED for behavior changes unless the feature specification explicitly waives them with a rationale.
